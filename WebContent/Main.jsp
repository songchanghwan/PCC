                ...
                <div id="nav">
                    ...
                    <ul>
                        <li class="m_menu">
                            <span>WEB Q & A</span>
                            <ul class="hide">
                                <li><a href="/PCC/pcc_board/HTMLCSS.jsp">HTML/CSS</a></li>
                                <li><a href="/PCC//pcc_board/Javascript.jsp">Javascript</a></li>
                                <li><a href="/PCC//pcc_board/JQuery.jsp">JQuery</a></li>
                            </ul>
                        </li>
                    </ul>
                    <ul>
                        <li class="m_menu">
                            ...
                            <ul class="hide">
                                <li><a href="/PCC/pcc_board/CC++.jsp">C/C++</a></li>
                                <li><a href="/PCC/pcc_board/C.jsp">C#</a></li>
                                <li><a href="/PCC/pcc_board/JAVA.jsp">JAVA</a></li>
                                <li><a href="/PCC/pcc_board/Python.jsp">Python</a></li>
                            </ul>
                        </li>
                    </ul>
                    <ul>
                        <li class="m_menu">
                            ...
                            <ul class="hide">
                                <li><a href="/PCC/pcc_board/PJA.jsp">PHP/JSP/ASP</a></li>
                                <li><a href="/PCC/pcc_board/Node.jsp">Node.js</a></li>
                            </ul>
                        </li>
                    </ul>
                    <ul>
                        <li class="m_menu">
                            <span>기타 Q & A</span>
                            <ul class="hide">
                                <li><a href="/PCC/pcc_board/suggest.jsp">건의사항</a></li>
                            </ul>
                        </li>
                    </ul>
                    </div>
                    ...
                    <ul>
                        <li class="m_menu">
                            <span>PCC 쉼터</span>
                            <ul class="hide">
                                <li><a href="/PCC/pcc_board/free.jsp">자유게시판입니다.</a></li>
                                <li><a href="/PCC/pcc_board/worry.jsp">고민나누기</a></li>
                                <li><a href="/PCC/pcc_board/humor.jsp">유머게시판</a></li>
                                <li><a href="/PCC/pcc_board/study.jsp">개인스터디 모집</a></li>
                                <li><a href="/PCC/pcc_board/developer.jsp">개발자 모임</a></li>
                            </ul>
                        </li>
                    </ul>
                    </div>
